...
public final class USBMonitor {
    ...
    private boolean isMyDevice(UsbDevice device) {
        boolean b = device.getProductName().contains("FX3") || device.getProductName().contains("Xtherm") || device.getProductName().contains("Xmodule") || device.getProductName().contains("S0") || device.getProductName().contains("T2") || device.getProductName().contains("DL") || device.getProductName().contains("T3") || device.getProductName().contains("DP");
        return b;
    }
