...
JNIEXPORT jint Java_be_ntmn_inficam_InfiCam_nativeStartStream(JNIEnv *env, jobject self, jobject surface) {
    InfiCamJNI *icj = getObject(env, self);
...
JNIEXPORT void Java_be_ntmn_inficam_InfiCam_setDistanceMultiplier(JNIEnv *env, jobject self, jfloat dm) {
    InfiCamJNI *icj = getObject(env, self);
...
JNIEXPORT void Java_be_ntmn_inficam_InfiCam_setTempReflected(JNIEnv *env, jobject self, jfloat val) {
    InfiCamJNI *icj = getObject(env, self);
...
JNIEXPORT jint Java_be_ntmn_inficam_InfiCam_nativeSetPalette(JNIEnv *env, jobject self, jintArray palette) {
    InfiCamJNI *icj = getObject(env, self);
