...
public abstract class Palette {
    ...
    private static final Palette WhiteHot = new Palette(
        R.string.palette_whitehot
    ) {
        @Override
    ...
    private static final Palette BlackHot = new Palette(
        R.string.palette_blackhot
    ) {
        @Override
        public Pixel func(double x) {
    ...
    private static final Palette RedCold = new Palette(
        R.string.palette_redcold
    ) {
        @Override
        public Pixel func(double x) {
    ...
    private static final Palette GreenHot = new Palette(
        R.string.palette_greenhot
    ) {
        @Override
        public Pixel func(double x) {
    ...
    private static final Palette GreenCold = new Palette(
        R.string.palette_greencold
    ) {
        @Override
        public Pixel func(double x) {
    ...
    private static final Palette Ironbow = new Palette(
        R.string.palette_ironbow
    ) {
        @Override
        public Pixel func(double x) {
    ...
    private static final Palette Rainbow = new Palette(
        R.string.palette_rainbow
    ) {
        @Override
        Pixel func(double x) {
    ...
    private static final Palette Rainbow2 = new Palette(
        R.string.palette_rainbow2
    ) {
        @Override
        Pixel func(double x) {
