...
public class BatteryLevel extends View {
    ...
    private static final int batColor = Color.WHITE;
    private static final int textColor = Color.WHITE;
    private static final int fillBackColor = Color.GRAY;
    private static final int emptyColor = Color.rgb(220, 20, 20);
    private static final int midColor = Color.rgb(220, 150, 0);
    private static final int fullColor = Color.rgb(20, 220, 20);
